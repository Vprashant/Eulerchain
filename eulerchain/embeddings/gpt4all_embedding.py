...
from eulerchain.embeddings.base_embedding import BaseEmbedding
from eulerchain.eulerchain_root.pydantic_v2 import BaseModel, root_validator


class GPT4AllEmbeddings(BaseModel, BaseEmbedding):
    """GPT4All embedding models.
    To use, you should have the gpt4all python package installed

    Example:
        .. code-block:: python
            from eulerchain.embeddings.gpt4all_embedding import GPT4AllEmbeddings
